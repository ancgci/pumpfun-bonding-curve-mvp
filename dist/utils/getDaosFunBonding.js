...
exports.calculateDaosFunCurveProgress = exports.getDaosFunBondingCurveAddress = void 0;
...
async function getDaosFunBondingCurveAddress(bondingCurve) {
    try {
        ...
        logger_1.default.info(`🔄 Obtendo informações da curva de bonding do daos.fun: ${bondingCurve}`);
        ...
        logger_1.default.error("❌ Erro ao obter informações da curva de bonding do daos.fun:", error);
        return "0.5";
    }
}
exports.getDaosFunBondingCurveAddress = getDaosFunBondingCurveAddress;
async function calculateDaosFunCurveProgress(bondingCurve) {
    try {
        ...
        logger_1.default.debug(`📈 Progresso calculado da curva daos.fun: ${clampedProgress.toFixed(2)}%`);
        return clampedProgress;
    }
    catch (error) {
        logger_1.default.error("❌ Erro ao calcular progresso da curva do daos.fun:", error);
        return 0;
    }
}
exports.calculateDaosFunCurveProgress = calculateDaosFunCurveProgress;
//# sourceMappingURL=getDaosFunBonding.js.map