...
exports.calculateBonkFunCurveProgress = exports.getBonkFunBondingCurveAddress = void 0;
...
async function getBonkFunBondingCurveAddress(bondingCurve) {
    try {
        ...
        logger_1.default.info(`🔄 Obtendo informações da curva de bonding do Bonk.fun: ${bondingCurve}`);
        ...
        logger_1.default.error("❌ Erro ao obter informações da curva de bonding do Bonk.fun:", error);
        return "0.5";
    }
}
exports.getBonkFunBondingCurveAddress = getBonkFunBondingCurveAddress;
async function calculateBonkFunCurveProgress(bondingCurve) {
    try {
        ...
        logger_1.default.debug(`📈 Progresso calculado da curva Bonk.fun: ${clampedProgress.toFixed(2)}%`);
        return clampedProgress;
    }
    catch (error) {
        logger_1.default.error("❌ Erro ao calcular progresso da curva do Bonk.fun:", error);
        return 0;
    }
}
exports.calculateBonkFunCurveProgress = calculateBonkFunCurveProgress;
//# sourceMappingURL=getBonkFunBonding.js.map