...
exports.calculateMoonshotCurveProgress = exports.getMoonshotBondingCurveAddress = void 0;
...
async function getMoonshotBondingCurveAddress(bondingCurve) {
    try {
        ...
        logger_1.default.info(`🔄 Obtendo informações da curva de bonding do Moonshot Screener: ${bondingCurve}`);
        ...
        logger_1.default.error("❌ Erro ao obter informações da curva de bonding do Moonshot Screener:", error);
        return "0.5";
    }
}
exports.getMoonshotBondingCurveAddress = getMoonshotBondingCurveAddress;
async function calculateMoonshotCurveProgress(bondingCurve) {
    try {
        ...
        logger_1.default.debug(`📈 Progresso calculado da curva Moonshot Screener: ${clampedProgress.toFixed(2)}%`);
        return clampedProgress;
    }
    catch (error) {
        logger_1.default.error("❌ Erro ao calcular progresso da curva do Moonshot Screener:", error);
        return 0;
    }
}
exports.calculateMoonshotCurveProgress = calculateMoonshotCurveProgress;
//# sourceMappingURL=getMoonshotBonding.js.map