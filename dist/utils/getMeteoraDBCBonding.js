...
exports.calculateMeteoraDBCCurveProgress = exports.getMeteoraDBCBondingCurveAddress = void 0;
...
async function getMeteoraDBCBondingCurveAddress(bondingCurve) {
    try {
        ...
        logger_1.default.info(`🔄 Obtendo informações da curva de bonding da Meteora DBC: ${bondingCurve}`);
        ...
        logger_1.default.error("❌ Erro ao obter informações da curva de bonding da Meteora DBC:", error);
        return "0.5";
    }
}
exports.getMeteoraDBCBondingCurveAddress = getMeteoraDBCBondingCurveAddress;
async function calculateMeteoraDBCCurveProgress(bondingCurve) {
    try {
        ...
        logger_1.default.debug(`📈 Progresso calculado da curva Meteora DBC: ${clampedProgress.toFixed(2)}%`);
        return clampedProgress;
    }
    catch (error) {
        logger_1.default.error("❌ Erro ao calcular progresso da curva da Meteora DBC:", error);
        return 0;
    }
}
exports.calculateMeteoraDBCCurveProgress = calculateMeteoraDBCCurveProgress;
//# sourceMappingURL=getMeteoraDBCBonding.js.map