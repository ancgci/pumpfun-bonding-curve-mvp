...
export const PremiumCard = ({
    ...
    return (
        <div
            ...
            onDrop={onDrop}
            className={cn(
                "bg-card/40 backdrop-blur-md border border-white/5 rounded-[2rem] p-8 flex flex-col shadow-xl transition-all duration-300",
            ...
            {(title || Icon || actions || draggable) && (
                <div className={cn("flex justify-between items-center mb-6", headerClassName)}>
                    <div className="flex items-center gap-3">
                        ...
                        {title && <h3 className="text-foreground font-semibold text-lg tracking-tight">{title}</h3>}
                    </div>
